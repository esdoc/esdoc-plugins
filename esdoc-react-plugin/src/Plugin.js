...
const ParamParser = require('@sebastianwessel/esdoc/out/src/Parser/ParamParser').default;
const DocBuilder = require('@sebastianwessel/esdoc-publish-html-plugin/out/src/Builder/DocBuilder').default;
